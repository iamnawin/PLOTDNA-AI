...
assert(localities.length === 200, `expected 200 Hyderabad localities, found ${localities.length}`)
assert(confidenceMentions >= 200, `expected confidence metadata for 200 Hyderabad records, found ${confidenceMentions}`)
