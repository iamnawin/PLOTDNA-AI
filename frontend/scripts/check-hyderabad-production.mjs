...
assert(mapView.includes("['==', ['get', 'dataState'], 'data-pending'], 0.12"), 'context/no-data fills must remain visible at overview zoom')
assert(mapView.includes("['==', ['get', 'dataState'], 'data-pending'], 0.66"), 'context/no-data borders must remain readable at overview zoom')
