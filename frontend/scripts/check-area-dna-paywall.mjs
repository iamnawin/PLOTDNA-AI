...
assert(verdict < exportPanel && exportPanel < buyerChecklist, 'export CTA should appear immediately after the AI verdict and before the checklist when preview is still open')
assert(exportPanel < accessGate && accessGate < buyerChecklist, 'timed gate should protect deep sections while hiding the separate top export offer after timeout')
