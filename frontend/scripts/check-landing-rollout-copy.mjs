...
assert(landing.includes('handleOpenArea'), 'landing must keep the explicit selected-location open action')
assert(landing.includes('Open Area'), 'landing must label the selected-location action clearly')
assert(landing.includes("selectCoords(coords, 'locate_me'"), 'Locate Me must prepare a location selection')
assert(landing.includes("selectCoords(result.coords, 'google_maps_link'"), 'map links must prepare a location selection')
