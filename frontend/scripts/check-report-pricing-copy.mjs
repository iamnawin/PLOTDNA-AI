...
assert(timedGate.includes('DNA verdict') && timedGate.includes('Source trail') && timedGate.includes('Buyer checklist'), 'timed lock should show included features without a second card')
