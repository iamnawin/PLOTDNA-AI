...
- Hyderabad, Bangalore, Mumbai, Chennai, and Pune expanded to resolver-grade coverage with stored localities, aliases, clusters, projects, sources, and verdict support

**Current gap:** PlotDNA is now a hybrid system, but market truth is still duplicated across frontend and backend. Hyderabad, Bangalore, Mumbai, Chennai, and Pune now have resolver-grade locality support, while Delhi NCR still needs the same structure.
...
- Hyderabad remains the deepest city in the system, with Bangalore, Mumbai, Chennai, and Pune now following as resolver-grade markets
- Hyderabad, Bangalore, Mumbai, Chennai, and Pune currently have stored localities, aliases, clusters, projects, and full verdict coverage
...
- Port the resolver-grade city model next to Delhi NCR
