...
of a land parcel or micro-market. Higher = better long-term investment.
...
```
DNA Score = Σ(weight × normalized_signal_score)
...
### RERA Activity (0–100)
- Count of new project registrations in last 24 months
- Weighted by project size (units)
- >50 new units/sq km = 80+

### Employment Hub Proximity (0–100)
- Distance to nearest IT park, SEZ, industrial estate
...
## Phase 1 Note
Phase 1 uses manually curated static scores for Hyderabad micro-markets.
These will be replaced with computed scores in Phase 2.
