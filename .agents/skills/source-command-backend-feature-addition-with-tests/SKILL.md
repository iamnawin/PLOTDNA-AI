---
name: "source-command-backend-feature-addition-with-tests"
description: "Workflow command scaffold for backend-feature-addition-with-tests in PLOTDNA-AI."
---

# source-command-backend-feature-addition-with-tests

Use this skill when the user asks to run the migrated source command `backend-feature-addition-with-tests`.
